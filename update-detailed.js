              ...
              <>
                ...
                <div className="mb-10 relative z-10 break-inside-avoid">
                  ...
                  <table className="w-full text-sm text-right border-collapse">
                    ...
                    <tbody>
                      {detailedStats.history.concat([{...detailedStats.commodity, recorded_at: new Date().toISOString()}]).sort((a: any, b: any) => new Date(b.recorded_at).getTime() - new Date(a.recorded_at).getTime()).slice(0, 50).map((h: any, idx: number) => (
